...
public class LeaveApplyBean {
	...
	public boolean leave(String ename, String email,  String gender,String phone, int no_of_days,
			String date_of_leave, String designation, int eid) throws Exception {
		Connection con=ConnectionEst.connecitvity();
		String sql="insert into leaves(ename,email,gender,phone,no_of_days,date_of_leave,designation,eid) values(?,?,?,?,?,?,?,?)";
